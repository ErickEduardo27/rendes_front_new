    ...
    <div class="space-y-4 max-h-[500px] overflow-y-auto pr-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="col-span-1 lg:col-span-2">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="block font-semibold text-sm text-gray-700">¿Serológica Actual?</label>
                        <select v-model="serologiaActual" class="w-full border rounded p-2 text-sm">
                            <option value="">Seleccione una opción</option>
                            <option value="1">VHB</option>
                            <option value="2">VHC</option>
                            <option value="3">VHI</option>
                        </select>
                    </div>
                    <div class="space-y-2">
                        <label class="block font-semibold text-sm text-gray-700">¿Condición Serológica Actual?</label>
                        <select v-model="condicionSero" class="w-full border rounded p-2 text-sm">
                            <option value="">Seleccione una opción</option>
                    ...
                    <div class="space-y-2">
                        ...
                        <select v-model="AcHBs" class="w-full border rounded p-2 text-sm">
                            <option value="">Seleccione una opción</option>
                            <option value="1">&lt; 10 No Responde</option>
