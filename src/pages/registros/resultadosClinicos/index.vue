...
const todosPacientesLista = computed(() => {
  ...
  return atenciones.map((a) => {
    ...
    return { id_paciente_atencion: id, tieneRegistro: false, paciente, documento, Hb: '', calcio: '', fosforo: '', PTHi: '', Alb: '', ktv: '', tiempo_dialisis: '', eritoproyetina: null, hierro: null, calcitriol: null };
  });
});
